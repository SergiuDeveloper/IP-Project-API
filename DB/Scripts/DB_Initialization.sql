CREATE SCHEMA IF NOT EXISTS Fiscal_Documents_Initialization_Schema;
USE Fiscal_Documents_Initialization_Schema;

DROP PROCEDURE IF EXISTS Fiscal_Documents_EDI_DB_Initialization;
DELIMITER //
CREATE PROCEDURE Fiscal_Documents_EDI_DB_Initialization()
BEGIN
...
CREATE SCHEMA IF NOT EXISTS Fiscal_Documents_EDI_Test;
USE Fiscal_Documents_EDI_Test;
CALL Fiscal_Documents_Initialization_Schema.Fiscal_Documents_EDI_DB_Initialization();

CREATE SCHEMA IF NOT EXISTS Fiscal_Documents_EDI_Live;
USE Fiscal_Documents_EDI_Live;
CALL Fiscal_Documents_Initialization_Schema.Fiscal_Documents_EDI_DB_Initialization();

USE Fiscal_Documents_Initialization_Schema;
DROP PROCEDURE IF EXISTS Fiscal_Documents_EDI_DB_Initialization;
DROP SCHEMA IF EXISTS Fiscal_Documents_Initialization_Schema;